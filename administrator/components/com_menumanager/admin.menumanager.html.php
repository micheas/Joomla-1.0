				...
				for ($m = $start; $m < $start + $count; $m++)
				{
					...
					<tr class="<?php echo "row" . $k; ?>">
						...
						<td width="30px" align="center">
							<input type="radio" id="cb<?php echo $i; ?>" name="cid[]" value="<?php echo $menu->type; ?>"
						...
						<td align="center">
							<a href="<?php echo $linkA; ?>" title="Edit Menu Items">
								<img src="<?php echo $mosConfig_live_site; ?>/includes/js/ThemeOffice/mainmenu.png"
								     border="0"/>
							</a>
						</td>
						<td align="center">
		...
		<form action="index2.php" method="post" name="adminForm">
			...
			<table class="adminform">
				<tr height="45px;">
					...
					<td>
						<input class="inputbox" type="text" name="menutype" size="30" maxlength="25"
						       value="<?php echo isset($row->menutype) ? $row->menutype : ''; ?>"/>
						<?php
				...
				if ($new)
				{
					...
					<tr>
						...
						<td>
							<input class="inputbox" type="text" name="title" size="30"
							       value="<?php echo $row->title ? $row->title : ''; ?>"/>
							<?php
							...
							<br/><br/><br/>
							<strong>
								* A new mod_mainmenu module, with the Title you have entered above will automatically be
								created when you save this menu. *
								<br/><br/>
								Parameters for the module created are to be edited through the 'Modules Manager [site]':
		...
		<form action="index2.php" method="post" name="adminForm">
			...
			<table class="adminform">
				<tr>
					...
					<td>
						* This will <strong><font color="#FF0000">Delete</font></strong> this Menu, <br/>ALL its Menu
						Items and the Module(s) associated with it *
						<br/><br/><br/>

						<div style="border: 1px dotted gray; width: 70px; padding: 10px; margin-left: 100px;">
							<a class="toolbar"
							   href="javascript:if (confirm('Are you sure you want to Delete this menu? \nThis will Delete the Menu, its Items and the Module(s).')){ submitbutton('deletemenu');}"
							   onmouseout="MM_swapImgRestore();"
							   onmouseover="MM_swapImage('remove','','images/delete_f2.png',1);">
