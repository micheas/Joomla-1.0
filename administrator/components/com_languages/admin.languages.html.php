					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td width="20">
							<input type="radio" id="cb<?php echo $i; ?>" name="cid[]"
							       value="<?php echo $row->language; ?>" onClick="isChecked(this.checked);"/>
						</td>
						<td width="25%">
							<a href="#edit"
							   onclick="hideMainMenu();return listItemTask('cb<?php echo $i; ?>','edit_source')"><?php echo $row->name; ?></a>
						</td>
	...
	function editLanguageSource($language, &$content, $option)
	{
		...
		<form action="index2.php" method="post" name="adminForm">
			...
			<table class="adminform">
				...
				<tr>
					<td><textarea style="width:100%" cols="110" rows="25" name="filecontent"
