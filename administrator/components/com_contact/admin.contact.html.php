		...
		<td width="60%" valign="top">
			<table width="100%" class="adminform">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="name" size="50" maxlength="100"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="con_position" size="50" maxlength="50"
						       value="<?php echo $row->con_position; ?>"/>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td>
						<input class="inputbox" type="text" name="email_to" size="50" maxlength="100"
						       value="<?php echo $row->email_to; ?>"/>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td>
						<input class="inputbox" type="text" name="address" size="50"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="suburb" size="50" maxlength="50"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="state" size="50" maxlength="20"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="country" size="50" maxlength="50"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="postcode" size="25" maxlength="10"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="telephone" size="25" maxlength="25"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="fax" size="25" maxlength="25"
