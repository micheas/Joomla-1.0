					...
					foreach ($browsers as $b)
					{
						...
						<tr class="row<?php echo $k; ?>">
							...
							<td align="left" width="<?php echo $width + 10; ?>">
								<div align="left">&nbsp;<img
										src="<?php echo $mosConfig_live_site; ?>/components/com_poll/images/blank.png"
										class="bar_<?php echo $c; ?>" height="6" width="<?php echo $w; ?>"></div>
							</td>
							<td align="left">
								<?php printf("%.2f%%", $f * 100); ?>
							</td>
			...
			<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminheading">
				...
				<span class="componentheading">logging is :
					...
					<td align="right">
						...
						{
							?>
							<input name="search_results" type="button" class="button" value="Hide Search Results"
							       onclick="submitbutton('searches');">
						<?php
						}
						else
						{
							?>
							<input name="search_results" type="button" class="button" value="Show Search Results"
							       onclick="submitbutton('searchesresults');">
						<?php
						}
						?>
					</td>
