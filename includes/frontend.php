...
function mosShowHead()
{
	...
	{
		?>
		<script src="<?php echo $mosConfig_live_site; ?>/includes/js/joomla.javascript.js"
	...
	if ($live_bookmark)
	{
		...
		if ($show)
		{
			...
			?>
			<link rel="alternate" type="application/rss+xml" title="<?php echo $mosConfig_sitename; ?>"
			      href="<?php echo $link_file; ?>"/>
		<?php
		}
	}
