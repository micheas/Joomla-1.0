...
class HTML_content
{
				...
				<tr>
					<td width="60%" valign="top" class="contentdescription<?php echo $params->get('pageclass_sfx'); ?>"
						...
						if ($params->get('description_image') && $title->image)
						{
							...
							?>
							<img src="<?php echo $link; ?>" align="<?php echo $title->image_position; ?>" hspace="6"
				...
				<td width="100%">
					...
					if (($access->canEdit || $access->canEditOwn) && $categories_exist)
					{
						...
						<a href="<?php echo $link; ?>">
							<img src="<?php echo $mosConfig_live_site; ?>/images/M_images/new.png" width="13"
							     height="14" align="middle" border="0" alt="<?php echo _CMN_NEW; ?>"/>
							&nbsp;<?php echo _CMN_NEW; ?>...</a>
						<br/><br/>
					<?php
					}
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				if ($params->get('headings'))
				{
					...
					<tr>
						...
						{
							?>
							<td align="center" class="sectiontableheader<?php echo $params->get('pageclass_sfx'); ?>"
							    width="5%">
	...
	function EditIcon(&$row, &$params, &$access)
	{
		...
		<a href="<?php echo sefRelToAbs($link); ?>"
		   onmouseover="return overlib('<?php echo $overlib; ?>', CAPTION, '<?php echo _E_EDIT; ?>', BELOW, RIGHT);"
	...
	function editContent(&$row, $section, &$lists, &$images, &$access, $myid, $sectionid, $task, $Itemid)
	{
			...
			function submitbutton(pressbutton) {
				...
				if (form.title.value == "") {
					...
					if (getSelectedValue('adminForm', 'catid') < 1) {
						...
						//	alert ( "
						<?php echo addslashes( _E_WARNTEXT ); ?>" );
					} else {
						<?php
			...
			<tr>
				<td class="contentheading">
					...
					<a href="javascript: void(0);"
					   onMouseOver="return overlib('<table><?php echo $docinfo; ?></table>', CAPTION, '<?php echo _E_ITEM_INFO; ?>', BELOW, RIGHT);"
					   onMouseOut="return nd();">
						<strong>[Info]</strong>
					</a>
				</td>
		...
		<table class="adminform">
			...
			<tr>
				<td valign="top">
					...
					<br/>
					<input class="button" type="button" value="<?php echo _E_INSERT; ?>"
					       onclick="addSelectedToList('adminForm','imagefiles','imagelist')"/>
				</td>
				<td width="2%">
					<input class="button" type="button" value=">>"
					       onclick="addSelectedToList('adminForm','imagefiles','imagelist')"
					       title="<?php echo _E_ADD; ?>"/>
					<br/>
					<input class="button" type="button" value="<<"
					       onclick="delSelectedFromList('adminForm','imagelist')" title="<?php echo _E_REMOVE; ?>"/>
				</td>
				<td valign="top">
					<?php echo $lists['imagelist']; ?>
					<br/>
					<input class="button" type="button" value="<?php echo _E_UP; ?>"
					       onclick="moveInList('adminForm','imagelist',adminForm.imagelist.selectedIndex,-1)"/>
					<input class="button" type="button" value="<?php echo _E_DOWN; ?>"
					       onclick="moveInList('adminForm','imagelist',adminForm.imagelist.selectedIndex,+1)"/>
				</td>
				<td valign="top">
					<table>
						...
						<tr>
							...
							<td>
								<input class="button" type="button" value="<?php echo _E_APPLY; ?>"
			...
			<tr>
				<td>
					<img name="view_imagefiles" src="<?php echo $mosConfig_live_site; ?>/images/M_images/blank.png"
					     width="50" alt="<?php echo _E_NO_IMAGE; ?>"/>
				</td>
				<td width="2%">
				</td>
				<td>
					<img name="view_imagelist" src="<?php echo $mosConfig_live_site; ?>/images/M_images/blank.png"
					     width="50" alt="<?php echo _E_NO_IMAGE; ?>"/>
				</td>
				<td>
				</td>
		...
		<table class="adminform">
			...
			<tr>
				...
				<td>
					<input type="text" name="created_by_alias" size="50" maxlength="100"
					       value="<?php echo $row->created_by_alias; ?>" class="inputbox"/>
				</td>
			</tr>
			<tr>
				<td align="left">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="publish_up" id="publish_up" size="25" maxlength="19"
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="publish_down" id="publish_down" size="25" maxlength="19"
		...
		<table class="adminform">
			<tr>
				...
				<td>
					<textarea class="inputbox" cols="45" rows="3"
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					<td colspan="2">
						...
						&nbsp;&nbsp;
						<input type="button" name="cancel" value="<?php echo _BUTTON_CANCEL; ?>" class="button"
