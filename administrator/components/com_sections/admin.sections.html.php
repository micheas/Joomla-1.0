			...
			<td valign="top" width="60%">
				<table class="adminform">
					...
					<tr>
						...
						<td colspan="2">
							<input class="text_area" type="text" name="name" value="<?php echo $row->name; ?>" size="50"
							       maxlength="255" title="A long name to be displayed in headings"/>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td rowspan="5" width="50%">
							...
							?>
							<img src="<?php echo $path . $row->image; ?>" name="imagelib" width="80" height="80"
							     border="2" alt="Preview"/>
						</td>
					</tr>
					<tr>
						<td>
			...
			<table class="adminform">
				<tr>
					...
					<td align="left" valign="top" width="30%">
						...
						<br/>
						<input class="text_area" type="text" name="title" value="" size="35" maxlength="50"
						       title="The new Section name"/>
						<br/><br/>
					</td>
