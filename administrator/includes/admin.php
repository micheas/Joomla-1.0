...
function josSecurityCheck($width = '95%')
{
	...
	if (count($wrongSettingsTexts))
	{
		?>
		<div
			style="clear: both; margin: 3px; margin-top: 10px; padding: 5px 15px; display: block; float: left; border: 1px solid #cc0000; background: #ffffcc; text-align: left; width: <?php echo $width; ?>;">
			<p style="color: #CC0000;">
				The following PHP Server Settings are not optimal for <strong>Security</strong> and it is recommended to
				change them:
			</p>
			...
			<p style="color: #666;">
				Please check <a href="http://www.joomla.org/security10" target="_blank"
				                style="color: blue; text-decoration: underline">the Official Joomla! Server Security
