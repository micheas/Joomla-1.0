		...
		<table class="adminlist">
			...
			for ($i = 0, $n = count($rows); $i < $n; $i++)
			{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						<a href="javascript: void(0);"
						   onclick="return listItemTask('cb<?php echo $i; ?>','<?php echo $task_access; ?>')" <?php echo $color_access; ?>>
	...
	function edit(&$row, &$images, &$lists, &$params, $option, &$menus)
	{
		...
		<td width="60%" valign="top">
			<table class="adminform">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="title" size="30" maxlength="100"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="title_alias" size="30" maxlength="100"
						       value="<?php echo $row->title_alias; ?>"/>
					</td>
				</tr>
				<tr>
		...
		<table class="adminform">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="text" name="created" id="created" size="25" maxlength="19"
		...
		<table class="adminform">
			...
			<tr>
				<td align="left">
					Description:<br/>
					<textarea class="inputbox" cols="40" rows="5" name="metadesc"
					          style="width:300px"><?php echo str_replace('&', '&amp;', $row->metadesc); ?></textarea>
				</td>
			</tr>
			<tr>
				<td align="left">
					Keywords:<br/>
					<textarea class="inputbox" cols="40" rows="5" name="metakey"
					          style="width:300px"><?php echo str_replace('&', '&amp;', $row->metakey); ?></textarea>
				</td>
			</tr>
		</table>
		<?php
