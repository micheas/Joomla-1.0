...
// if only one, then 100% no matter which one.
	...
	?>
	<meta http-equiv="Content-Type" content="text/html; <?php echo _ISO; ?>"/>
	<link href="<?php echo $mosConfig_live_site; ?>/templates/madeyourweb/css/template_css.css" rel="stylesheet"
	      type="text/css"/>
	<link href="<?php echo $mosConfig_live_site; ?>/templates/madeyourweb/css/css_color_green.css" rel="stylesheet"
	      type="text/css"/>
</head>
	...
	<div id="header">
		<div id="top-top">
			...
			<div id="topmenu">
				...
				{
					?><?php mosLoadModules('user3', -1); ?><?php
				} ?>
			</div>
		</div>
		...
		<div id="top-bottom">
			<a href="index.php">
				<img src="<?php echo $mosConfig_live_site; ?>/templates/<?php echo $GLOBALS['cur_template'] ?>/images/logo.gif"
				     border="0"
				     width="250"
				     height="80"
				     alt="logo"/>
