...
function view()
{
	...
	if (count($wrongSettingsTexts))
	{
		...
		<div class="install-text">
			<p>
				Following PHP Server Settings are not optimal for <strong>Security</strong> and it is recommended to
				change them:
			</p>

			<p>
				Please check <a href="http://forum.joomla.org/index.php/topic,81058.0.html" target="_blank">the Official
					Joomla! Server Security post</a> for more information.
			</p>
	...
	<div class="install-text">
		<p>
			In order for Joomla! to function correctly it needs to be able to access or write to certain files or
			directories.
		</p>

		<p>
			If you see "Unwriteable" you need to change the permissions on the file or directory to allow Joomla! to
			write to it.
		</p>
