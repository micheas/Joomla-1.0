		...
		<form action="index2.php" method="post" name="adminForm">
			...
			<table class="adminform">
				...
				<tr>
					...
					?>
					<td>
						<input class="inputbox" type="text" name="imptotal" size="12" maxlength="11"
						       value="<?php echo $_row->imptotal; ?>"/>
						&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="clickurl" size="100" maxlength="200"
						       value="<?php echo $_row->clickurl; ?>"/>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input name="reset_hits" type="button" class="button" value="Reset Clicks"
				...
				<tr>
					...
					<td>
						<textarea class="inputbox" cols="70" rows="5"
						          name="custombannercode"><?php echo $_row->custombannercode; ?></textarea>
					</td>
				</tr>
				<tr>
					<td valign="top">
		...
		<form action="index2.php" method="post" name="adminForm">
			<table class="adminform">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="name" size="30" maxlength="60" valign="top"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="contact" size="30" maxlength="60"
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="email" size="30" maxlength="60"
				...
				<tr>
					...
					<td>
						<textarea class="inputbox" name="extrainfo" cols="60"
						          rows="10"><?php echo str_replace('&', '&amp;', $row->extrainfo); ?></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3">
