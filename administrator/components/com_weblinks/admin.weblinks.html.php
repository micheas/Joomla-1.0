					...
					<td width="60%" valign="top">
						<table class="adminform">
							...
							<tr>
								...
								<td width="80%">
									<input class="text_area" type="text" name="title" size="50" maxlength="250"
							...
							<tr>
								...
								<td>
									<input class="text_area" type="text" name="url" value="<?php echo $row->url; ?>"
							...
							<tr>
								...
								<td>
									<textarea class="text_area" cols="50" rows="5" name="description"
									          style="width:500px"
									          width="500"><?php echo $row->description; ?></textarea>
								</td>
							</tr>
