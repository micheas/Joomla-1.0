...
class HTML_admin_misc
{
	...
	function system_info($version)
	{
		...
		<table class="adminform">
			...
			<tr>
				<td>
					<strong>For all Joomla! functions and features to work ALL of the following directories should be
						writeable:</strong>
					<?php
		...
		<form name="adminForm">
			<table class="adminform" border="1">
						...
						<table width="100%">
							<tr>
								<td>
									...
									<input type="text" name="helpsearch" value="<?php echo $helpsearch; ?>"
									       class="inputbox"/>
									<input type="submit" value="Go" class="button"/>
									<input type="button" value="Clear Results" class="button"
								...
								<td style="text-align:right">
									...
									{
										?>
										<a href="<?php echo $mosConfig_live_site; ?>/help/joomla.glossary.html"
										   target="helpFrame">
											Glossary</a>
										|
										<a href="<?php echo $mosConfig_live_site; ?>/help/joomla.credits.html"
										   target="helpFrame">
											Credits</a>
										|
										<a href="<?php echo $mosConfig_live_site; ?>/help/joomla.support.html"
										   target="helpFrame">
											Support</a>
									<?php
									}
									...
									<a href="http://help.joomla.org" target="_blank">
										help.joomla.org</a>
									|
									<a href="<?php echo $mosConfig_live_site; ?>/administrator/index3.php?option=com_admin&task=changelog"
									   target="helpFrame">
										Changelog</a>
									|
									<a href="<?php echo $mosConfig_live_site; ?>/administrator/index3.php?option=com_admin&task=sysinfo"
									   target="helpFrame">
										System Info</a>
									|
				...
				<tr valign="top">
					...
					<td valign="top">
						<iframe name="helpFrame" src="<?php echo $mosConfig_live_site . '/help/' . $page; ?>"
						        class="helpFrame" frameborder="0"/>
						</iframe>
					</td>
				</tr>
			</table>
		...
		<table class="adminform">
			...
			<tr>
				<td width="100%" valign="top" colspan="2">
					<iframe name="previewFrame" src="<?php echo $mosConfig_live_site . '/index.php?tp=' . $tp; ?>"
					        class="previewFrame"/>
					</iframe>
				</td>
			</tr>
