...
class HTML_Media
{
								...
								<td>
									<table border="0" align="right" cellpadding="0" cellspacing="4" width="600">
										...
										<tr>
											...
											<td>
												<input class="inputbox" type="text" name="imagecode"
												       style="width:400px"/>
											</td>
										</tr>
									</table>
							...
							<table width="99%" align="center" border="0" cellspacing="2" cellpadding="2">
											...
											<tr>
												...
												<td class="buttonOut" width="10">
													<a href="javascript:dirup()">
														<img src="components/com_media/images/btnFolderUp.gif"
														     width="15" height="15" border="0" alt="Up"/>
													</a>
												</td>
												<td align="right">
													File Upload
													...
													&nbsp;&nbsp;&nbsp;&nbsp;
													<input class="inputbox" type="file" name="upload" id="upload"
													       size="63"/>&nbsp;
												</td>
											</tr>
										</table>
								...
								<tr>
									<td align="center" bgcolor="white">
										<div class="manager">
											<iframe height="360"
											        src="index3.php?option=com_media&amp;task=list&amp;listdir=<?php echo $listdir ?>"
											        name="imgManager" id="imgManager" width="100%" marginwidth="0"
	...
	function draw_no_dir()
	{
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td>
					<div align="center"
					     style="font-size:small;font-weight:bold;color:#CC0000;font-family: Helvetica, sans-serif;">
	...
	function show_image($img, $file, $info, $size, $listdir)
	{
		...
		<div style="float:left; padding: 5px">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=delete&amp;delFile=<?php echo $file; ?>&amp;listdir=<?php echo $listdir; ?>&amp;<?php echo josSpoofValue(); ?>=1"
					   target="_top" onclick="return deleteImage('<?php echo $file; ?>');" title="Delete Item">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0"
						     alt="Delete"/></a>
					<a href="#"
					   onclick="javascript:window.top.document.forms[0].imagecode.value = '<img src=&quot;<?php echo $img_url_link; ?>&quot; align=&quot;left&quot; hspace=&quot;6&quot; alt=&quot;Image&quot; />';"
					   title="Image Code">
						<img src="components/com_media/images/edit_pencil.gif" width="15" height="15" border="0"
						     alt="Code"/></a>
				</div>
			</div>
		</div>
	...
	function show_dir($path, $dir, $listdir)
	{
		...
		<div style="float:left; padding: 5px">
			<div class="imgTotal"
			     onmouseover="return overlib( '<?php echo $overlib; ?>', CAPTION, '<?php echo $dir; ?>', BELOW, RIGHT, WIDTH, 150 );"
			     onmouseout="return nd();">
				<div align="center" class="imgBorder">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=deletefolder&amp;delFolder=<?php echo $path; ?>&amp;listdir=<?php echo $listdir; ?>&amp;<?php echo josSpoofValue(); ?>=1"
					   target="_top" onclick="return deleteFolder('<?php echo $dir; ?>', <?php echo $num_files; ?>);">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0"
						     alt="Delete"/></a>
				</div>
			</div>
	...
	function show_doc($doc, $size, $listdir, $icon)
	{
		...
		<div style="float:left; padding: 5px">
			<div class="imgTotal"
			     onmouseover="return overlib( '<?php echo $overlib; ?>', CAPTION, '<?php echo $doc; ?>', BELOW, RIGHT, WIDTH, 200 );"
			     onmouseout="return nd();">
				<div align="center" class="imgBorder">
					<a href="index3.php?option=com_media&amp;task=list&amp;listdir=<?php echo $listdir; ?>"
					   onclick="javascript:window.top.document.forms[0].imagecode.value = '<a href=&quot;<?php echo $doc_url_link; ?>&quot;>Insert your text here</a>';">
			...
			<div class="imginfoBorder">
				...
				<div class="buttonOut">
					<a href="index2.php?option=com_media&amp;task=delete&amp;delFile=<?php echo $doc; ?>&amp;listdir=<?php echo $listdir; ?>&amp;<?php echo josSpoofValue(); ?>=1"
					   target="_top" onclick="return deleteImage('<?php echo $doc; ?>');">
						<img src="components/com_media/images/edit_trash.gif" width="15" height="15" border="0"
						     alt="Delete"/></a>
				</div>
			</div>
