		...
		<div class="install">
			...
			<div id="right">
				...
				<div class="install-text">
					...
					<p>Install the sample data unless you are an experienced Joomla! User wanting to start with a
						completely empty site.</p>
				</div>
					...
					<div class="form-block">
						<table class="content2">
							...
							<tr>
								...
								<td>
									<em>Some hosts allow only a certain DB name per site. Use table prefix in this case
										for distinct Joomla! sites.</em>
								</td>
							</tr>
							<tr>
								<td colspan="2">
							...
							<tr>
								<td>
									<input type="checkbox" name="DBDel" id="DBDel"
									       value="1" <?php if ($DBDel) echo 'checked="checked"'; ?> />
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="DBBackup" id="DBBackup"
									       value="1" <?php if ($DBBackup) echo 'checked="checked"'; ?> />
								</td>
								<td>
									<label for="DBBackup">Backup Old Tables</label>
								</td>
								<td>
									<em>Any existing backup tables from former Joomla! installations will be
										replaced</em>
								</td>
							</tr>
							<tr>
								<td>
									<input type="checkbox" name="DBSample" id="DBSample"
									       value="1" <?php if ($DBSample) echo 'checked="checked"'; ?> />
								</td>
								<td>
