		...
		<table class="pollstableborder" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td colspan="2" class="sectiontableheader">
					<img src="<?php echo $mosConfig_live_site; ?>/components/com_poll/images/poll.png" align="middle"
					     border="0" width="12" height="14" alt=""/>
					<?php echo $graphtitle; ?>
				</td>
			</tr>
			<?php
								...
								<td width="300" align="left">
									<div align="left">
										...
										<img
											...
											class='<?php echo $tdclass; ?>' height='<?php echo $polls_barheight; ?>'
											width='<?php echo $width; ?>' alt=""/>
									</div>
								</td>
							</tr>
						</table>
