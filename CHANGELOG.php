...
Better
mysql
statement in content.searchbot.php
#
Fixed [artf5141]
:
image
...
variable
not
defined in functions in gacl.api.class.php
#
Fixed [artf3978]
:
...
slashes
not
stripped in WebLinks
#
Fixed [artf5215][artf5412]
:
Successfully
Saved
Item: {
...
* globals.php
not
included in administrator / index.php
...
Krzeszowiec
#
PERFORMANCE [topic, 83325]
:
SQL
LIMIT in com_content
frontend
...
:
Problem
with Description / Description Image
parameters
of
...
XSS
vulerability in getUserStateFromRequest()
...
Fixed [topic, 68168]
:
Typo / administrator / components / com_content / admin.content.html.php - line
478
#
Fixed [topic, 68168]
:
Typo / administrator / components / com_typedcontent / admin.typedcontent.html.php - line
266
...
Fixed [artf4806]
:
typo in mambots / search / contacts.searchbot.php
causes
sef
errors
#
...
:
Can
't add Menu Item :: Link - Static Content
#
Fixed : "Unique Itemid"
handling
for `
...
:
incorrect
style in function botNoEditorEditorArea
#
Fixed [topic, 57926]
:
mod_poll.php
...
preview
doesn
't work with custom directory
#
Fixed [topic, 54741]
:
Who
's Online guest count increments with RSS feed access
...
always
displayed
if 'Linked Titles' option
enabled
#
Fixed [artf4304]
:
Bugs in search.html.php
#
Fixed : Content
Popup
page
...
:
Correction
needed in stylesheet
#
Fixed [artf4089]
:
Problem
with domit, extended characters
and
PHP
5.0
.2
...
#
Fixed [topic, 47932.0.html]
:
1.0
.8
com_contact - incorrect
URL ?
...
dynamic
content
while searching for static
	#
updated
core - SEF
support
for new multilingual_content config
var
...
Kempkens
+ Check
for mambot / system directory in installer
and
installation
dialogs
#
...
primary
key
for translations(contact, newsfeed)
...
Invalid
Itemid
for com_content Category
Link
#
Fixed [topic, 45343.0.html]
:
Random
image
default
...
Problem
#
Fixed [topic, 41627.0.html]
:
"Undefined variable: filter"
#
Fixed [topic, 43315.0.html]
:
Static
text in content.php
#
Fixed [topic, 41466.0.html]
:
NullDate
AND
'0000-00-00 00:00:00'
...
it
is
used - com_newsfeeds, com_syndicate, custom
modules
...
Path
error
for agent_browser.php in joomla.php
	#
Fixed
ensure
all
...
#
Fixed [topic, 41619.0.html]
:
mosimage
caption
problem
#
Fixed [topic, 42023.0.html]
:
sample
data
error
with Link - Static Content
CID
value
...
:
invalid
markup in com_content
showCategories()
#
Fixed [artf3688]
:
Hardcoded
text in contact.html.php
#
Fixed [artf3664]
:
Image
...
server
path
disclosure in mod_templatechooser
...
- Depreciated
Admin
templates - mambo_admin & mambo_admin_blue
...
loaded
only
once - affect = reduction in queries
	^ Refactored
session
handling
code
...
previous
query
results - affect = reduction in queries
	^ PERFORMANCE
: `
static
`
...
content
is
loaded - affect = reduction in queries
	^ PERFORMANCE
:
individual
'content'
...
to
load
params - mosemailcloak, mosimage, mosloadposition, mospaging - affect = reduction in queries
	^ PERFORMANCE
:
'editor-xtd'
bot
...
only
when
needed - affect = reduction in queries
...
compliant
#
Fixed [topic, 31185.0.html]
:
heading in pagination
not
working
#
Fixed [topic, 10947.0.html]
:
Add
Prefix
check
...
and & & link
not
defined in admin.categories.php
#
Fixed [artf3446]
:
Problems
with mosimage with caption
	#
Fixed [artf3100]
:
Incorrect
...
small
problem
with variable in xml_domit_lite_parser.php
	#
Fixed [topic, 34620.0.html]
:
Excessive
Joomla
Sessions, and
...
block
text
if section / category 'access level'
denies
access
...
Fixed [artf2070]
:
mosHTML:encoding_converter()
breaks
with &
ouml;
#
Fixed
missing < li > tag in newsfeed
component
#
Fixed [artf1487]
:
...
out
`
check in  mod_latestnews.php
and
mod_mostread.php
- unnecessary
param
variable in mod_latestnews.php
...
:
Undefined
constant in php_http_exceptions.php
...
^ Replaced
install.png
with transparent image - contributed
by
joomlashack
#
Fixed [artf2245]
...
Fixed [artf2222]
:
ampReplace in content.html.php
	+ Versioncheck
for new_link parameter
for mysql_connect.
...
Fixed [artf2219]
:
Bug in pageNavigation.php - added
"if not define _PN_LT or _PN_RT"
...
#
Fixed : Can
't create new folders in media manager
...
charset = utf - 8
to
charset = iso - 8859 - 1 in language
file
...
Gigataras
#
PERFORMANCE: Fixed [artf1993]
:
Inefficient
queries in com_content
#
Fixed [artf2021]
:
[artf1791]
...
incorrect
url
's at next/previous links at content items
#
Fixed [artf2079]
:
SQL
...
:
Check
for custom icon in mod_quickicon.php
...
Fixed
custom() & customX()
functions in menu.html.php
no
checking
for image in /administrator/images /
...
:
Manage
Banners | Error in Field
Name
#
Fixed [artf1597]
:
Small
bug in loadAssocList
function
in
database.php
#
...
:
Undefined
index: 2 in includes / joomla.php
on
line
2721
#
...
Threat
* Fixed
securitybug in admin.content.html.php
when
2
logged in and
try
...
Install1.php
doesn
't enforce rule against old_ table prefix
...
Error
at
"number of Trashed Items" in sections
#
Fixed [artf1415]
:
Wrong
image in editList()
function of mosToolBar
class
...
template,
with link to
'Joomla! 1.0.x Series Information'
#
Fixed [artf1175]
:
Create
...
:
Can
't cancel "Submit - Content" menu item type form
#
Fixed [artf1172]
:
"Help"
link in Administration
links
to
Mamboserver.com
#
...
of
compressed
tinymce_gzip.php [[artf1088] || [artf1034] || [artf1090] || [artf1044]]
#
Installed
Editor
Mambots
...
com_categories
can
't edit category when clicking hyperlink
#
Fixed [artf1053]
:
Can
...
Subtle
bug in saveUser() - admin.users.php
#
Fixed [
#
7120
...
width
issues
with Admin template in IE
^ Fixed
some
UI
issues
with Banners Component
^ Added
a
default
header
...
Fixed
issue
with new content where
Categories
weren
't displayed for sections
...
system
bot
's for better integration of ml support, ssl & multi sites
...
auto
mapping
function to mosAbstractTasker
constructor
+ Added
patHTML
class
for patTemplate utility
methods
^ Upgraded
patTemplate
library
